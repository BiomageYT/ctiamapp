...
public class ConBelAdapter extends RecyclerView.Adapter<ConBelAdapter.ProductoViewHolder> implements View.OnClickListener {

    private Context context;
    private ArrayList<Producto> productos;
    private int cursor;

    public ConBelAdapter(Context context, ArrayList<Producto> productos, int cursor) {
