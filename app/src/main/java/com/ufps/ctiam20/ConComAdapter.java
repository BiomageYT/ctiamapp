...
public class ConComAdapter extends RecyclerView.Adapter<ConComAdapter.ProductoViewHolder> implements View.OnClickListener {

    private Context context;
    private ArrayList<Producto> productos;
    private int cursor;

    public ConComAdapter(Context context, ArrayList<Producto> productos, int cursor) {
