...
public class ConHogAdapter extends RecyclerView.Adapter<ConHogAdapter.ProductoViewHolder> implements View.OnClickListener {

    private Context context;
    private ArrayList<Producto> productos;
    private int cursor;

    public ConHogAdapter(Context context, ArrayList<Producto> productos, int cursor) {
