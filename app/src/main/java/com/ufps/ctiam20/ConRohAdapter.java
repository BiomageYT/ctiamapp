...
public class ConRohAdapter extends RecyclerView.Adapter<ConRohAdapter.ProductoViewHolder> implements View.OnClickListener {

    private Context context;
    private ArrayList<Producto> productos;
    private int cursor;

    public ConRohAdapter(Context context, ArrayList<Producto> productos, int cursor) {
