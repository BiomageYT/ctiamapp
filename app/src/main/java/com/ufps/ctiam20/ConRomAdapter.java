...
public class ConRomAdapter extends RecyclerView.Adapter<ConRomAdapter.ProductoViewHolder> implements View.OnClickListener {

    private Context context;
    private ArrayList<Producto> productos;
    private int cursor;

    public ConRomAdapter(Context context, ArrayList<Producto> productos, int cursor) {
