...
public class ConBelFragment extends Fragment {

    RecyclerView contenedorproductos;
    FloatingActionButton botonIrProducto;

    private ConBelViewModel conbelViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        conbelViewModel =
                new ViewModelProvider(this).get(ConBelViewModel.class);
        //AQUI VA EL FRAGMENTO QUE INFLÓ , DEJO PRODUCTOS DE MOMENTO PERO VA fragment_con_bel
