...
public class ConComFragment extends Fragment {

    RecyclerView contenedorproductos;
    FloatingActionButton botonIrProducto;

    private ConComViewModel concomViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        concomViewModel =
                new ViewModelProvider(this).get(ConComViewModel.class);
        //AQUI VA EL FRAGMENTO QUE INFLÓ , DEJO PRODUCTOS DE MOMENTO PERO VA fragment_con_com
