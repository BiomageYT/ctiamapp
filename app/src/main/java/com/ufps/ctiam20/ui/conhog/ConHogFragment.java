...
public class ConHogFragment extends Fragment {

    RecyclerView contenedorproductos;
    FloatingActionButton botonIrProducto;

    private ConHogViewModel conhogViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        conhogViewModel =
                new ViewModelProvider(this).get(ConHogViewModel.class);
        //AQUI VA EL FRAGMENTO QUE INFLÓ , DEJO PRODUCTOS DE MOMENTO PERO VA fragment_con_hog
