...
public class ConTecFragment extends Fragment {

    RecyclerView contenedorproductos;
    FloatingActionButton botonIrProducto;

    private ConTecViewModel contecViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        contecViewModel =
                new ViewModelProvider(this).get(ConTecViewModel.class);
        //AQUI VA EL FRAGMENTO QUE INFLÓ , DEJO PRODUCTOS DE MOMENTO PERO VA fragment_con_tec
