...
public class LpFragment extends Fragment {
    ...
    private LpViewModel lpViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {

        lpViewModel =
                new ViewModelProvider(this).get(LpViewModel.class);
        //AQUI VA EL FRAGMENTO QUE INFLÓ , DEJO TIENDAS DE MOMENTO PERO VA fragment_lp
