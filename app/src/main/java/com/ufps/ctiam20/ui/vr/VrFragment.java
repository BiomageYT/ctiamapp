...
public class VrFragment extends Fragment {
    RecyclerView contenedorTiendaVr;

    private VrViewModel vrViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {

        vrViewModel =
                new ViewModelProvider(this).get(VrViewModel.class);
        //AQUI VA EL FRAGMENTO QUE INFLÓ , DEJO TIENDAS DE MOMENTO PERO VA fragment_vr
        View view = inflater.inflate(R.layout.fragment_vr, container, false);
        contenedorTiendaVr=view.findViewById(R.id.contenedortiendasvr);
        LinearLayoutManager linearLayout = new LinearLayoutManager(getContext());
        linearLayout.setOrientation(LinearLayoutManager.VERTICAL);
        contenedorTiendaVr.setLayoutManager(linearLayout);
        TiendaAdapter tiendaAdapter = new TiendaAdapter(getActivity(),cargarDatos(),R.id.card);
        contenedorTiendaVr.setAdapter(tiendaAdapter);
